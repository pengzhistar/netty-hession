...
public class RemoteInterfaceProxyFactory {
	...
	public <T> T create(Class<T> api, String beanName) {
		...
		InvocationHandler invokeHandler = new RemoteInterfaceProxy(beanName,
				this);
		Object obj = Proxy.newProxyInstance(_loader, new Class[] { api,
				HessianRemoteObject.class }, invokeHandler);
		return api.cast(obj);
	}
